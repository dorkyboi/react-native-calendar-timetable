...
function Timetable({ items, renderItem, date, range: rangeProp, fromHour = 0, toHour = 24, style, width, timeWidth = 50, itemMinHeightInMinutes = 25, hourHeight = 60, linesTopOffset = 18, linesLeftInset = 15, columnHorizontalPadding = 10, renderHeader, startProperty = 'startDate', endProperty = 'endDate', ...props }) {
    ...
    return (<Animated.ScrollView horizontal={true} snapToInterval={props.enableSnapping ? columnWidth : undefined} onScroll={Animated.event([{ nativeEvent: { contentOffset: { x: scrollX } } }], {
