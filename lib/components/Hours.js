...
function Hours({ offsetX, columnDays, columnWidth, linesTopOffset, linesLeftOffset, fromHour, toHour, hourHeight, timeWidth, is12Hour, timeStyle, timeContainerStyle, linesStyle, }) {
    const timeFontSize = timeStyle?.fontSize || 14;
    const renderTime = (hour) => is12Hour
